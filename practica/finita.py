...
# origin_signal_h = int(input("Ingresa la posición de punto de origen de h(x): "))
# signal_g = input("Ingresa g(x): ")
# origin_signal_g = int(input("Ingresa la posición de punto de origen de g(x): "))
	...
	for r in range(0,tam_matriz):
		for c in range(0,1):
			for k in range(0,tam_matriz):
				...
				# array_res.append(matriz_b[r,k] *  matriz_a[k,c])
	print("g(x)*h(x)= ")
	# print(array_res)
# print(matriz_a)
# print(matriz_b)
